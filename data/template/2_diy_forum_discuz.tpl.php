...
block_get('4,3');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frametR4i92" class="frame move-span cl frame-3-1"><div class="title frame-title"><span class="titletext">3-1框架</span></div><div id="frametR4i92_left" class="column frame-3-1-l"><div id="frametR4i92_left_temp" class="move-span temp"></div><?php block_display('4');?></div><div id="frametR4i92_center" class="column frame-3-1-r"><div id="frametR4i92_center_temp" class="move-span temp"></div><?php block_display('3');?></div></div></div><!--[/diy]-->
</div>
<?php } ?>
