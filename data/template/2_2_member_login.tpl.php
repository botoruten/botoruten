...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1385476021, '2', './data/template/2_2_member_login.tpl.php', './template/BBSMOD', 'member/login')
