...
0
|| checktplrefresh('./template/default/common/header.htm', './template/BBSMOD/common/header_common.htm', 1385476045, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/BBSMOD', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1385476045, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/BBSMOD', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1385476045, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/BBSMOD', 'common/header_forum_forumdisplay')
;?>
...
<!--for菜单-->
        <link rel="stylesheet" type="text/css" href="./template/BBSMOD/css/normalize.css" />

<link rel="stylesheet" type="text/css" href="./template/BBSMOD/css/icons.css" />
<link rel="stylesheet" type="text/css" href="./template/BBSMOD/css/style1.css" />
<script src="./template/BBSMOD/js/modernizr.custom.js" type="text/javascript"></script>
</head>
...
<li><a href="#" class="bt-icon icon-window-delete">Download</a></li>
    ...
    <script src="./template/BBSMOD/js/classie.js" type="text/javascript"></script>
<script src="./template/BBSMOD/js/borderMenu.js" type="text/javascript"></script>
...
var today =NewDate("2014-01-19 00:00");
var birthDay=new Date();
var timeold=today.getTime()-birthDay.getTime();
//alert("2014-01-19 00:00");
...
document.getElementById("showsecdtime").innerHTML = "离放假还有"+Yearsold+"年"+daysold+"天"+hrsold+"小时"+minsold+"分钟"+seconds+"秒";
