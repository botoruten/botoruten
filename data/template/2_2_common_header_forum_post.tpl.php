...
0
|| checktplrefresh('./template/default/common/header.htm', './template/BBSMOD/common/header_common.htm', 1385231509, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/BBSMOD', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1385231509, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/BBSMOD', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1385231509, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/BBSMOD', 'common/header_forum_post')
;?>
